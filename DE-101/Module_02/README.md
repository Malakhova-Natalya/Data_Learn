...
- **создать 3 таблицы и загрузить данные из excel-файла Superstore в базу данных / Excel, DBeaver**
- **написать SQL-запросы, чтобы ответить на вопросы из Модуля 01 / DBeaver**
- **нарисовать модели данных для Superstore / SqlDBM**
- **выполнить DDL в SQL клиенте / DBeaver**
